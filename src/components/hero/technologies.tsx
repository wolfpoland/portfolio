"use client";
import { Card, CardHeader } from "patryk/components/ui/card";
      ...
      <Card className="bg-primary-foreground gap-3 z-20 p-2 flex items-center justify-center">
        ...
        <HoverCard>
          ...
          <HoverCardContent>
            ...
            can make my own libraries – looking at the types in things like
            React Table can be pretty scary. But I&apos;m trying hard to get
            better and reach that level soon.
          </HoverCardContent>
        </HoverCard>
        <HoverCard>
          <HoverCardTrigger>
          ...
          <HoverCardContent>
            ...
            projects, I&apos;ve switched to using Redux Toolkit.
          </HoverCardContent>
        </HoverCard>
        <HoverCard>
          <HoverCardTrigger>
